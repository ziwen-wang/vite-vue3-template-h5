...
export declare namespace WebhooksModel {
    ...
    type Event = 'file.translated' | 'file.approved' | 'project.translated' | 'project.approved' | 'translation.updated' | 'suggestion.added' | 'suggestion.updated' | 'suggestion.deleted' | 'suggestion.approved' | 'suggestion.disapproved';
